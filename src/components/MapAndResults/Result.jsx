    ...
    <>
      {isFetchingGeojson ? (
        ...
        <div className="  py-1 min-w-[250px] overflow-y-auto">
          <h5 className="font-[500] text-center  sm:text-right">
            {electionType}
          </h5>

          <ul className="flex flex-col gap-2 float-right mt-4">
              ...
              >
                ...
                {item.revisedVoteShare - item.voteShare >= 0 ? (
                  ...
                  <span className="flex text-sm">
                    ...
                    {Math.abs(item.revisedVoteShare - item.voteShare)?.toFixed(
                      0
                    )}
                    %
                  </span>
                ...
                <span
                  className={clsx(
                    "px-8 py-[6px] font-semibold flex justify-center items-center rounded-2xl w-[180px] text-sm ml-4 text-white "
                  )}
                  style={{
                ...
                >
                  {item.seatCount}
                  <span className="font-[300] text-[12px] px-1">&gt;&gt;</span>
                  ...
                  {Math.abs(item.revisedSeatCount?.toFixed(0) - item.seatCount)}
                </span>
              </li>
            ))}
          </ul>
